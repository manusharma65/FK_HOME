  ...
  render() {
    return '' +
      '<div id="lv-mod" class="fk-mod">' +
        '<style>' +
          '#lv-mod .avatar{width:30px;height:30px;border-radius:50%;display:inline-flex;align-items:center;justify-content:center;font-size:13.5px;font-weight:500;color:#3a3a36;flex-shrink:0}' +
          ...
          '#lv-mod .bal-cell .lbl{font-size:13.5px;color:var(--muted);margin-bottom:2px}' +
          ...
          '#lv-mod .disclose{background:none;border:none;color:var(--muted);cursor:pointer;font-size:14.5px;display:inline-flex;align-items:center;gap:4px;padding:0}' +
