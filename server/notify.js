...
const TEMPLATES = {
  ...
  'attendance.regularise.requested': {
    ...
    recipients: c => 'managers_of:' + c.actorUserId,
    action_url: c => '#hr/regularisations',
  ...
  'task.opened': {
    ...
    recipients: c => [c.targetUserId],
    action_url: c => c.relatedUserId ? '#profile/' + c.relatedUserId + '/reviews' : '#my-work',
    related_type: 'task',
  },
  'task.due': {
  ...
  'probation.confirmed': {
    ...
    recipients: c => c.hrUserIds || [],
    action_url: c => '#profile/' + c.targetUserId,
    related_type: 'user',
  },
  'probation.end_due': {
    ...
    recipients: c => [c.targetUserId],
    action_url: c => '#profile/' + c.subjectUserId,
    related_type: 'user',
  },
