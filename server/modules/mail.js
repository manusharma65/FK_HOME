  ...
  if (!gmail) {
    return { 
      messages: [{
        ...
        from: 'system@fksports.co.uk', to: userEmail, subject: 'Local Environment Active ✔',
...
router.get('/message/:id', async (req, res) => {
  try {
    ...
    if (!gmail) return res.json({ id: req.params.id, from: 'mock@fksports.co.uk', to: mb.gmail_address, subject: 'Local Mock', text: 'Service account offline.' });
